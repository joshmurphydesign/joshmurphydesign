...
const NPC_USERS: SeedUser[] = [
  {
    ...
    name: "Maya Chen",
    handle: "mayasprints",
    avatarColor: "linear-gradient(135deg,#1e3a66,#2e7bff)",
    avatarInitials: "MC",
    focus: ["running", "habits"],
  ...
  },
  {
    ...
    name: "Andre Walsh",
    handle: "drewalsh",
    avatarColor: "linear-gradient(135deg,#05070d,#2e7bff)",
    avatarInitials: "AW",
  ...
  },
  {
    ...
    name: "Sam Ibarra",
    handle: "samplays",
    avatarColor: "linear-gradient(135deg,#63a8ff,#1e3a66)",
    avatarInitials: "SI",
    focus: ["golf", "mobility"],
  ...
  },
  {
    ...
    name: "Priya Nair",
    handle: "priyalifts",
    avatarColor: "linear-gradient(135deg,#2e7bff,#53d6ff)",
    avatarInitials: "PN",
  ...
  },
  {
    ...
    name: "Jonah Ricci",
    handle: "jricci",
    avatarColor: "linear-gradient(135deg,#1e3a66,#ff5a6a)",
    avatarInitials: "JR",
  ...
  },
  {
    ...
    name: "Devon Okafor",
    handle: "devono",
    avatarColor: "linear-gradient(135deg,#2e7bff,#63a8ff)",
    avatarInitials: "DO",
    focus: ["basketball", "habits"],
...
const GOALS: SeedGoal[] = [
  {
    ...
    streak: 12,
    bestStreak: 33,
    coverGradient: "linear-gradient(135deg,#1e3a66,#2e7bff)",
    metricType: "binary",
  ...
  },
  {
    ...
    streak: 6,
    bestStreak: 14,
    coverGradient: "linear-gradient(135deg,#2e7bff,#53d6ff)",
    metricType: "binary",
  ...
  },
  {
    ...
    progress: 42,
    streak: 3,
    coverGradient: "linear-gradient(135deg,#1e3a66,#53d6ff)",
    metricType: "decrease",
    metricTargetValue: 6,
    participants: [
  ...
  },
  {
    ...
    progress: 80,
    streak: 9,
    coverGradient: "linear-gradient(135deg,#1e3a66,#ff5a6a)",
  ...
  },
  {
    ...
    progress: 20,
    streak: 2,
    coverGradient: "linear-gradient(135deg,#05070d,#2e7bff)",
  ...
  },
  {
    ...
    progress: 27,
    streak: 4,
    coverGradient: "linear-gradient(135deg,#0b1020,#1e3a66)",
  ...
  },
  {
    ...
    progress: 11,
    streak: 6,
    coverGradient: "linear-gradient(135deg,#63a8ff,#1e3a66)",
    isPublic: true,
    metricType: "cumulative",
...
const POSTS: SeedPost[] = [
  {
    ...
    imageUrl: coverArt("#1e3a66", "#53d6ff", "\u{1F525}"),
  ...
  },
  {
    ...
    imageUrl: coverArt("#1e3a66", "#2e7bff", "\u{1F463}"),
  ...
  // so these double as the ledger the Insights completion-rate/consistency strip reads from.
  {
    ...
    imageUrl: coverArt("#1e3a66", "#2e7bff", "\u{1F4AA}"),
    createdAt: hoursAgo(14),
    reactions: [],
    comments: [],
  },
...
async function main() {
  ...
  await db.user.create({
    data: {
      ...
      avatarColor: "linear-gradient(135deg,#1e3a66,#2e7bff)",
      avatarInitials: "JM",
      focus: JSON.stringify(["strength", "running", "habits"]),
