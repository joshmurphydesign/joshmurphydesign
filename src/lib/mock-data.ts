...
export const USERS: User[] = [
  ...
  },
  {
    ...
    name: "Andre Walsh",
    handle: "drewalsh",
    avatarColor: "linear-gradient(135deg,#ff2d6b,#ff8a3d)",
    avatarInitials: "AW",
  ...
  },
  {
    ...
    name: "Sam Ibarra",
    handle: "samplays",
    avatarColor: "linear-gradient(135deg,#3dd6ff,#6a4cff)",
    avatarInitials: "SI",
    focus: ["golf", "mobility"],
  ...
  },
  {
    ...
    name: "Jonah Ricci",
    handle: "jricci",
    avatarColor: "linear-gradient(135deg,#ffc23d,#ff2d6b)",
    avatarInitials: "JR",
  ...
  },
  {
    ...
    name: "Tasha Brooks",
    handle: "tashab",
    avatarColor: "linear-gradient(135deg,#6a4cff,#3dd6ff)",
    avatarInitials: "TB",
  ...
  },
  {
    ...
    name: "Devon Okafor",
    handle: "devono",
    avatarColor: "linear-gradient(135deg,#ff5c3d,#ffc23d)",
    avatarInitials: "DO",
...
export const GOALS: Goal[] = [
  {
    ...
    progress: 62,
    streak: 12,
    coverGradient: "linear-gradient(135deg,#3d2ee0,#ff5c3d)",
    participants: [
  ...
  },
  {
    ...
    progress: 38,
    streak: 6,
    coverGradient: "linear-gradient(135deg,#6a4cff,#3dd6ff)",
    participants: [
  ...
  },
  {
    ...
    progress: 80,
    streak: 9,
    coverGradient: "linear-gradient(135deg,#ffc23d,#ff2d6b)",
    participants: [
  ...
  },
  {
    ...
    progress: 33,
    streak: 4,
    coverGradient: "linear-gradient(135deg,#ff2d6b,#3d2ee0)",
    participants: [
...
export const POWER_PLAYS: PowerPlay[] = [
  {
    ...
    coverGradient: "linear-gradient(135deg,#3d2ee0,#ff2d6b)",
  },
  {
    id: "pp-weekend-steps",
  ...
  },
  {
    ...
    coverGradient: "linear-gradient(135deg,#c8ff3d,#6a4cff)",
  },
];
